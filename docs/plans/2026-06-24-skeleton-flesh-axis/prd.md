...
- **代码地图放 `references/`,不新开 `map/` tier**(已定 2026-06-24)。理由:references/ 本就是肉地图层(source-index 一直在那);为 3~5 文件新开 tier 违反渐进严格、且把肉查阅材料劈成两层;清晰来自"提纯 architecture/ + 声明",不来自加 tier。地图多到成为主要导航面时再按压力升级。
