...
| [orchestration.md](orchestration.md) | Project-level multi-agent orchestration patterns, especially CSV-wave execution with `spawn_agents_on_csv` | Documenting downstream harness execution contracts or recording wave/state/result schemas |
